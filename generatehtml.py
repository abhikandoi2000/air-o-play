...
def gen_html(path):
	...
	html = html + '<head><title>' + str.capitalize(curr) + ' - ' + sitename + '</title><link rel="stylesheet" href="' + base_path + '/style.css' + '" type="text/css" /><script src="' + base_path + '/resize.js' + '"></script></head>'
	html = html + '<body>'
	html = html + '<!-- header starts  --><div id="header-wrapper"><div id="header"><h1 class="logo"><a href="' + base_path + '/index.html' + '" title="' + sitename + '">' + sitename + '</a></h1><div class="caption">Airing the fun.</div></div></div><!-- header ends -->'
